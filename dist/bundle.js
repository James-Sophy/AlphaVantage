(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('neat-csv'), require('cross-fetch')) :
  typeof define === 'function' && define.amd ? define(['neat-csv', 'cross-fetch'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.alphavantage = factory(global.neatCsv, global.fetch));
})(this, (function (neatCsv, fetch) { 'use strict';

  function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

  var neatCsv__default = /*#__PURE__*/_interopDefaultLegacy(neatCsv);
  		...
  		try {
  			...
  			if(data['Meta Data'] === undefined &&
  			   ...
  			   data['data'] === undefined
  				...
  				throw `An AlphaVantage error occurred. ${data['Note'] || data['Information'] || resp}`;
  			}
  			return data;
  		} catch(error){
  			return neatCsv__default["default"](resp);
  		}
        });
